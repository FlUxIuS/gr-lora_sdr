...
class lora_sim(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_data_source_sim_0 = lora_sdr.data_source_sim(pay_len, n_frame, '', 200, False)
        ...
        self.blocks_tag_debug_0_0_2 = blocks.tag_debug(gr.sizeof_int*1, 'after_gray', "")
        self.blocks_tag_debug_0_0_2.set_display(True)
        self.blocks_tag_debug_0_0_1_0 = blocks.tag_debug(gr.sizeof_char*1, 'after_header', "")
        self.blocks_tag_debug_0_0_1_0.set_display(True)
        self.blocks_tag_debug_0_0_1 = blocks.tag_debug(gr.sizeof_char*1, 'after_deinter', "")
        self.blocks_tag_debug_0_0_1.set_display(True)
        self.blocks_tag_debug_0_0 = blocks.tag_debug(gr.sizeof_int*1, 'after_fft_demod', "")
        self.blocks_tag_debug_0_0.set_display(True)
        self.blocks_tag_debug_0 = blocks.tag_debug(gr.sizeof_char*1, 'after_dewhit', "")
        ...
        self.connect((self.lora_sdr_dewhitening_0, 0), (self.blocks_tag_debug_0, 0))
        self.connect((self.lora_sdr_dewhitening_0, 0), (self.lora_sdr_crc_verif_0, 0))
        self.connect((self.lora_sdr_fft_demod_0, 0), (self.blocks_tag_debug_0_0, 0))
        ...
        self.connect((self.lora_sdr_gray_enc_0, 0), (self.blocks_tag_debug_0_0_2, 0))
        self.connect((self.lora_sdr_gray_enc_0, 0), (self.lora_sdr_deinterleaver_0, 0))
        self.connect((self.lora_sdr_hamming_dec_0, 0), (self.blocks_tag_debug_0_0_1, 0))
        self.connect((self.lora_sdr_hamming_dec_0, 0), (self.lora_sdr_header_decoder_0, 0))
        self.connect((self.lora_sdr_hamming_enc_0, 0), (self.lora_sdr_interleaver_0, 0))
        self.connect((self.lora_sdr_header_0, 0), (self.lora_sdr_add_crc_0, 0))
        self.connect((self.lora_sdr_header_decoder_0, 0), (self.blocks_tag_debug_0_0_1_0, 0))
        self.connect((self.lora_sdr_header_decoder_0, 0), (self.lora_sdr_dewhitening_0, 0))
        self.connect((self.lora_sdr_interleaver_0, 0), (self.lora_sdr_gray_decode_0, 0))
        self.connect((self.lora_sdr_modulate_0, 0), (self.blocks_throttle_1, 0))
