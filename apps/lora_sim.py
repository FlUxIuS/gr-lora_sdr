...
class lora_sim(gr.top_block):
    ...
    def __init__(self):
        ...
        self.interp_fir_filter_xxx_0_0.set_min_output_buffer(16384)
        self.blocks_throttle_1_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate,False)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.lora_sdr_hier_rx_0, 'ctrl_out'), (self.lora_sdr_hier_tx_0, 'ctrl_in'))
        self.connect((self.blocks_throttle_1_0, 0), (self.interp_fir_filter_xxx_0_0, 0))
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.lora_sdr_hier_rx_0, 0))
        self.connect((self.lora_sdr_hier_tx_0, 0), (self.blocks_throttle_1_0, 0))
