...
class lora_sim(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_modulate_0 = lora_sdr.modulate(sf, samp_rate, bw, False)
        ...
        self.blocks_tag_debug_1_0 = blocks.tag_debug(gr.sizeof_gr_complex*1, '', "")
        ...
        self.msg_connect((self.lora_sdr_header_decoder_0, 'CR'), (self.lora_sdr_crc_verif_0, 'CRC'))
        ...
        self.connect((self.blocks_throttle_1, 0), (self.blocks_tag_debug_1_0, 0))
        ...
        self.connect((self.lora_sdr_dewhitening_0, 0), (self.blocks_tag_debug_1, 0))
